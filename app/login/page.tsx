...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-20">
      <h1 className="text-center font-display text-4xl tracking-wide text-[#282828]">{t.login.title}</h1>
      <p className="mt-3 text-center text-sm text-[#282828]/70">{t.login.subtitle}</p>

      <form action={action} className="mt-10 space-y-5">
        <div>
          <label htmlFor="email" className="block text-xs font-semibold tracking-wider text-[#282828]/70 uppercase">{t.login.email}</label>
          <input
            id="email"
            name="email"
            type="email"
        ...
        <div>
          <label htmlFor="password" className="block text-xs font-semibold tracking-wider text-[#282828]/70 uppercase">{t.login.password}</label>
          <input
            id="password"
            name="password"
            type="password"
      ...
      <p className="mt-8 text-center text-sm text-[#282828]/70">
        {t.login.noAccount}{' '}
        <Link href="/signup" className="font-medium tracking-wider text-[#282828] transition hover:text-[#be1622]">
          {t.login.signUp}
        </Link>
      </p>
    </div>
